...
// ==================== FRONT VIEW ====================
// Image 270x585: body roughly x:15%-85%, head y:8%-22%, feet y:91%-97%
export const frontZones: AnatomicalZone[] = [
  ...
  },
  {
    ...
    structures: [
      ...
      { id: "femoral-nerve", name: "Бедренный нерв", type: "nerve" },
    ],
  },
  {
...
// ==================== LEFT SIDE VIEW ====================
// On the left-side photo, body roughly x:20%-80%, head y:7%-21%, feet y:91%-97%
